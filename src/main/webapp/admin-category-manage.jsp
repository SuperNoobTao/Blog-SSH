            ...
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                ...
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> <a href="${pageContext.request.contextPath}/category_updateui.action?categoryId=${tbCategoryEntity.categoryId}"> 编辑</a></button>&nbsp;
