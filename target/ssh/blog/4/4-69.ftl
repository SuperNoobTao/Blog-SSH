...
<div class="wrapper">
    ...
    <div class="content box">
        <h1 class="title article-title">12312321</h1>
        <div class="info">
            <div><a href="/stblog/listArticle.action?cid=4" title="查看该类型博文"><i class="icon-folder-open-alt"></i>：java111</a></div>
            <div><a href="#"><i class="icon-user"></i>：st1</a></div>
            <div><i class="icon-time"></i>：2016-06-12 08:52</div>
        </div>
        <p>本文为博主原创，允许转载，但请声明原文地址：<a href="http://localhost:8080/stblog/blog/4/4-69.html">http://localhost:8080/stblog/blog/4/4-69.html</a></p>
        
<p>//初始化封装文章实体 private Article initAddArticle() { Article article = new Article(); article.setCid(cid); article.setTime(date == null ? new Date() : date); article.setTitle(title); article.setType(type); article.setTop(top); //截取正文部分 content = content.substring(content.indexOf(&quot;</p>

<p>&quot;) + 6); content = content.substring(0, content.indexOf(&quot;</p>

<p>&quot;)); article.setContent(content); //提取文章摘要 if (content.length() &gt; 250) { int start = content.indexOf(&quot;<span style="\&quot;font-family:&quot;)">&quot;) + 1); meta = &quot;<span style="\&quot;font-family:微软雅黑;\&quot;">&quot; + meta + &quot;</span>&quot;; article.setMeta(meta); } else article.setMeta(content); return article; } </span></p>
