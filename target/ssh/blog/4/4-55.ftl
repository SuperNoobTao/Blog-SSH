...
<div class="wrapper">
    ...
    <div class="content box">
        <h1 class="title article-title">图片测试</h1>
        <div class="info">
            ...
            <div><i class="icon-time"></i>：2016-06-07 08:17</div>
        </div>
        <p>本文为博主原创，允许转载，但请声明原文地址：<a href="http://localhost:8080/stblog/blog/4/4-55.html">http://localhost:8080/stblog/blog/4/4-55.html</a></p>
        
<p>图片测试</p>

<p><img alt="" src="http://pic32.nipic.com/20130829/12906030_124355855000_2.png" style="width: 300px; height: 200px;" /></p>
