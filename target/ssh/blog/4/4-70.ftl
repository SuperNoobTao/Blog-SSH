...
<div class="wrapper">
    ...
    <div class="content box">
        ...
        <p>本文为博主原创，允许转载，但请声明原文地址：<a href="http://localhost:8080/stblog/blog/4/4-70.html">http://localhost:8080/stblog/blog/4/4-70.html</a></p>
        
<pre>
<span style="font-size:20px;">//初始化封装文章实体
