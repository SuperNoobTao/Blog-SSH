...
<div class="wrapper">
    ...
    <div class="content box">
        <h1 class="title article-title">solution299</h1>
        <div class="info">
            ...
            <div><i class="icon-time"></i>：2016-06-07 12:38</div>
        </div>
        <p>本文为博主原创，允许转载，但请声明原文地址：<a href="http://localhost:8080/stblog/blog/4/4-46.html">http://localhost:8080/stblog/blog/4/4-46.html</a></p>
...
<p>其中A前面的数字表示位置正确的数的个数，而B前的数字表示数字正确而位置不对的数的个数。</p>

<p>&nbsp;</p>

<p>只对你猜的数字进行解析，比如原数字 5234，你猜 5346，第一个5，34元素匹配但是位置不同。所以是1A2B</p>
