...
<div class="wrapper">
    ...
    <div class="content box">
        <h1 class="title article-title">豪车</h1>
        <div class="info">
            <div><a href="/stblog/listArticle.action?cid=12" title="查看该类型博文"><i class="icon-folder-open-alt"></i>：其他</a></div>
            <div><a href="#"><i class="icon-user"></i>：st1</a></div>
            <div><i class="icon-time"></i>：2016-06-14 11:17</div>
        </div>
        <p>本文为博主原创，允许转载，但请声明原文地址：<a href="http://localhost:8080/stblog/blog/12/12-75.html">http://localhost:8080/stblog/blog/12/12-75.html</a></p>
        
<p><img alt="" src="http://p0.so.qhimg.com/t01b0ff93335716f3df.png" style="width: 602px; height: 429px;" /></p>
