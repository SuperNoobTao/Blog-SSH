...
<div class="wrapper">
    ...
    <div class="content box">
        <h1 class="title article-title">213213123</h1>
        <div class="info">
            ...
            <div><i class="icon-time"></i>：2016-06-07 09:27</div>
        </div>
        <p>本文为博主原创，允许转载，但请声明原文地址：<a href="http://localhost:8080/stblog/blog/5/5-59.html">http://localhost:8080/stblog/blog/5/5-59.html</a></p>
