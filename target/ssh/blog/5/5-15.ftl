...
<div class="wrapper">
    ...
    <div class="content box">
        <h1 class="title article-title">${#articleTitle#}</h1>
        <div class="info">
            ...
            <div><i class="icon-time"></i>：2016-06-06 05:51</div>
        </div>
        <p>本文为博主原创，允许转载，但请声明原文地址：<a href="http://localhost:8080/stblog/blog/5/5-15.html">http://localhost:8080/stblog/blog/5/5-15.html</a></p>
        ${#articleContent#}
        <p>本文为博主原创，允许转载，但请声明原文地址：<a href="http://localhost:8080/stblog/blog/5/5-15.html">http://localhost:8080/stblog/blog/5/5-15.html</a></p>
        <div class="record">
            <div>
        ...
        <div class="last-next">
            ...
            <div>
                <a href="${nextArticle.articleStaicUrl}" title="下一篇">
